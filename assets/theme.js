  ...
  theme.headerNav = (function() {
    ...
    function openSearchDrawer(evt) {
      ...
      theme.utils.prepareTransition(container, function() {
        ...
        // // add Recently Viewed modal under Search bar when there's history - am
        // displayRecentView();
      }.bind(this));

      // function displayRecentView() {
      ...
      //     return;
      //   }
      //   document.getElementById("recent-view-popup").style.display = "flex";
      // }
    ...
    function closeSearchDrawer(evt) {
      ...
      // // close Recently Viewed modal when Search bar closes - am
      // document.getElementById("recent-view-popup").style.display = "none";
  ...
  theme.predictiveSearch = (function() {
    ...
    function predictQuery(q) {
      ...
      .then(suggestions => {
        ...
        // // close Recently Viewed modal when Search results display - am
        // document.getElementById("recent-view-popup").style.display = "none";
